...
class UserServiceTest {
  ...
  private final UserRepository users =
      new UserRepository() {
        ...
        public void save(User user) {
          store.put(user.getBlockchainAddress(), user);
        }
      };
  ...
  private final UserService service =
      new UserService(
          ...
          () -> "alice",
          new AccessPolicy(metadata, () -> "alice"));

  @Test
  void registerUsesCallerAndIgnoresUntrustedBalanceAndRole() {
  ...
  @Test
  void changeDataPreservesAddressRoleAndBalance() {
